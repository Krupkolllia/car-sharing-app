...
VALUES
    (1, 'test.user@mail.com',
     '$2a$12$Bx.Pdcm6JggueZYewe1lC.1xWBtMr85se/AnlW4MujOefLH2izXoi',
     'test', 'user', 'CUSTOMER'),
    (2, 'test.manager@mail.com',
     '$2a$12$vfXgg4N72YCshq0/yEmAEe/LmF7qbpFhP3UgZarqI90bb4OLTZgiG',
